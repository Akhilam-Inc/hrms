<template>
	...
	<div class="flex flex-row justify-between items-center mt-2">
		...
		<div class="flex flex-row gap-3 items-center">
			...
			<Button
				...
				icon="plus"
				variant="subtle"
				@click="openModal(item, idx,expenseClaim.expenses,0)"
			/>
		</div>
	</div>
	...
	>
		<div
			...
			:key="idx"
			@click="openModal(item, idx,expenseClaim.expenses,1)"
		>
...
const openModal = async (item, idx,expenses,update_expense) => {
